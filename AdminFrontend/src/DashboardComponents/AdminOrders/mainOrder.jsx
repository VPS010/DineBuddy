...
const UnifiedAdminOrder = () => {
  ...
  const [orders, setOrders] = useState([
    ...
    },
    {
      ...
      createdAt: new Date(),
      items: [
        { id: 3, name: "Pizza", quantity: 1, price: 200, spiceLevel: "Mild" },
        {
          id: 4,
          name: "Garlic Bread",
          quantity: 1,
    ...
    },
    {
      ...
      createdAt: new Date(),
      items: [
        { id: 5, name: "Pasta", quantity: 2, price: 120, spiceLevel: "Spicy" },
        { id: 6, name: "Salad", quantity: 1, price: 60, spiceLevel: "None" },
      ],
    ...
    },
    {
      ...
      createdAt: new Date(),
      items: [
        { id: 7, name: "Steak", quantity: 2, price: 180, spiceLevel: "Mild" },
        {
          id: 8,
    ...
    },
    {
      ...
      createdAt: new Date(),
      items: [
        { id: 10, name: "Wrap", quantity: 1, price: 60, spiceLevel: "Medium" },
        {
          id: 11,
          name: "Smoothie",
          quantity: 1,
    ...
    },
    {
      ...
      createdAt: new Date(),
      items: [
        { id: 14, name: "Coffee", quantity: 2, price: 25, spiceLevel: "None" },
        { id: 15, name: "Brownie", quantity: 1, price: 25, spiceLevel: "None" },
      ],
